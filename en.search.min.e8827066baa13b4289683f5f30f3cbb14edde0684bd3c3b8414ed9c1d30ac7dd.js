...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.975d9e16ac59b1ec8b5211c2a3b0ebbb6e3a9b10cf933ab95074f32f24e1be85.js',function(){input.required=false;search();});}
